    ...
    <div>
      ...
      <CollapsibleSection title="Search, Coffee & Export — the bottom-bar shortcuts">
        <ul className="list-disc list-inside space-y-2 text-sm text-gray-700">
          ...
          <li><span className="font-semibold">Coffee</span> shows everyone rostered today who's set a coffee preference (see Settings below), grouped into one order you can copy or text straight to your department's coffee place, if one's configured. Filter by Morning/Afternoon/Night with the checkboxes at the top. Got a locum or visitor not on the roster? Use "Add someone not on the roster" at the bottom to tack their coffee onto the same order.</li>
